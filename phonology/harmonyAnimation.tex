...
\newcommand{\qualitativeLong}[7]{
    ...
    \visible<3->{
      \node[align=left,anchor=right] at ($(t.west) + (-0.5,0)$) {constraint--based\\\phantom{t}synthesis\\\phantom{t}[Solar-Lezama 2008]\\test-driven synthesis\\\phantom{t}[Perelman et al. 2016]};
    }
