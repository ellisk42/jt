...
\title{DreamCoder:\\Growing generalizable, interpretable knowledge with wake-sleep Bayesian program learning}
...
\institute{colala group meeting} 
\date{2020}
...
\begin{frame}{Human program induction}
  \begin{tabular}{c}
    \includegraphics[width = 8cm]{seasons}\\
    Piantadosi 2020: also kinship, subway routes, counting, ...
  \end{tabular}\pause

  \vspace{1cm}
  \begin{tabular}{c}
    \includegraphics[width = 4cm]{drum_rhythm}\\
    Evans 2019, ``Apperception.'' Also visual occlusion, analogies, ...
    \end{tabular}
\end{frame}
...
\begin{frame}{}
  \begin{center}
    \begin{tabular}{l}
      {\textcolor{black}{Program Induction and learning to learn}}
    \end{tabular}
  \end{center}
\end{frame}
...
\begin{frame}{Some unresolved questions}
  ...
  Not everything is crisp and symbolic. How do we learn neurosymbolic hybrid programs?
  ...
  Is this a good model for human learning and thinking? % How can we answer this question behaviorally, when the space of program induction models is so under-constrained?
...
\begin{frame}{What we want for the future of machine learning}
  ...
  Strong generalization \pause %%in many domains
  ...
  Bootstrapping, learning-to-learn, representation learning\pause
