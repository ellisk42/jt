...
\begin{frame}{Library learning}
  ...
  \only<11>{  \Wider[5em]{\includegraphics[width = \textwidth]{figures/figureOneFinal4}}}
%  \only<5>{  \Wider[5em]{\includegraphics[width = \textwidth]{figures/figureOneFinal5}}}

  \only<4>{\tiny inducing sort program found in $\leq 10$min. Brute-force search without learned library would take $\approx 10^{78}$ years to discover this solution}
