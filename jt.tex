...
\begin{frame}{What computational substrates can contribute to this picture?}
  Three AI traditions: Symbolic, Probabilistic, Neural

  \pause

  \Wider[5em]{
    \textbf{Program induction}: roots in the works of Solomonoff, Fodor, McCarthy. Combines and complements these three traditions.

    \includegraphics[width = 0.8\textwidth]{../ecPaper/Brendan.jpg}\hspace*{-0.7\textwidth}
    \pause
    \vspace{1cm}    
    \includegraphics[width = 0.8\textwidth]{../ecPaper/theory}
  }
