...
\title{\texorpdfstring{\normalsize\sout{Algorithms for Learning to Induce Programs}}\Huge\phantom{test}\\\Large Building Machines that Discover Generalizable, Interpretable Knowledge}
\author{Kevin Ellis}
\institute{MIT} 
\date{2020}
