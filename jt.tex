...
\institute{Cornell; MIT; PLDI 2021}
%\date{2021}
...
\begin{frame}{}
  \begin{center}
    \begin{tabular}{l}
      {\textcolor{black}{DreamCoder and {\textcolor{black}{learning to learn}}}}\\
      {\phantom{DreamCoder and }\textcolor{gray}{learning a library}}\\
      {\phantom{DreamCoder and }\textcolor{gray}{learning to search}}\\
      {\phantom{DreamCoder and }{\textcolor{gray}{synergy between library+learned search}}}\\
    \end{tabular}
  \end{center}
\end{frame}
...
\begin{frame}{Learning to write code} %Growing domain-specific knowledge}
  ...
  \Wider[4em]{
    \begin{itemize}
    \item Library of components \\ %; generative model over programs)
      \item Search strategy (synthesis algorithm)
      \end{itemize}
  }
...
\begin{frame}{}
  \begin{center}
    \begin{tabular}{l}
      {\textcolor{black}{DreamCoder and {\textcolor{gray}{learning to learn}}}}\\
      {\phantom{DreamCoder and }\textcolor{black}{learning a library}}\\
      {\phantom{DreamCoder and }\textcolor{gray}{learning to search}}\\
      {\phantom{DreamCoder and }{\textcolor{gray}{synergy between library+learned search}}}\\
    \end{tabular}
  \end{center}
...
\begin{frame}{}
  \begin{center}
    \begin{tabular}{l}
      {\textcolor{black}{DreamCoder and {\textcolor{gray}{learning to learn}}}}\\
      {\phantom{DreamCoder and }\textcolor{gray}{learning a library}}\\
      {\phantom{DreamCoder and }\textcolor{black}{learning to search}}\\
      {\phantom{DreamCoder and }{\textcolor{gray}{synergy between library+learned search}}}\\
    \end{tabular}
  \end{center}
\end{frame}
...
\begin{frame}{}
  \begin{center}
    \begin{tabular}{l}
      ...
      {\phantom{DreamCoder and }\textcolor{gray}{learning a library}}\\
      {\phantom{DreamCoder and }\textcolor{gray}{learning to search}}\\
      {\phantom{DreamCoder and }{\textcolor{black}{synergy between library+learned search}}}\\
    \end{tabular}
  \end{center}
\end{frame}
