...
\begin{frame}{Why programs?}
  ...
  \visible<5->{\messageOverlay{main challenge:\\combinatorial search}}
...
\begin{frame}{}
  \begin{center}
    \begin{tabular}{l}
      {\textcolor{black}{Higher-level Knowledge: }}\\
...
\begin{frame}{Synergy between dreaming and library learning (higher-level knowledge)}
  \begin{tikzpicture}[scale=1.5]
    {
    \begin{scope}[shift = {(1,-1)}]
    \node[align = center](synthesis) at (6,4) {Discovery};
