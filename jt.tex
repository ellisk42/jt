...
\begin{frame}{What does DreamCoder dream of?}
  \emph{after} learning:
  \Wider[5em]{
    \includegraphics[width=\textwidth]{dc/dreams/cherry_picked/montageSeptember14}    
  }
...
\begin{frame}{Modeling the physical world} %$\sim$vaporware$\sim$}
  \Wider[5em]{
    \begin{center}
      \input{vapor.tex}
    \end{center}
...
\begin{frame}{What's far off, but worthwhile?}
  A far-off, long-term goal for AI: Making machines that can learn to solve the full span of problems humans can master,
  while also learning from modest amounts of experience, and acquiring knowledge that can be interpreted and extended
...
\Wider[4em]{  \begin{tabular}{cccc}
    ...
    \multicolumn{2}{c}{\visible<2>{\textbf{\Large thank you}}}
    \end{tabular}}
