...
\begin{frame}{Why program induction?}
  ...
  \only<5>{\messageOverlay{Challenge: Combinatorial search,\\\phantom{tt}massive compute time}}
\end{frame}
...
\begin{frame}{}
  \begin{center}
    \begin{tabular}{l}
      ...
      {\phantom{Program Induction and }\textcolor{gray}{learning a library}}\\
%      {\phantom{Program Induction and }\textcolor{gray}{learning to synthesize}}\\
      {\phantom{Program Induction and }{\textcolor{gray}{synergy between library \& neural search}}}\\
    \end{tabular}
  \end{center}
\end{frame}
...
\Wider[4em]{
  \begin{center}
    \phantom{library learning via program analysis + }\\
    \phantom{new neural inference network for program synthesis + }\\
    \phantom{better program representation (Lisp+polymorphic types [Milner 1978])}
  \end{center}
}
\myPaper{Ellis, Wong, Nye, ..., Solar-Lezama, Tenenbaum. arxiv 2020.}
\end{frame}
...
\begin{frame}{Abstraction as analogy --- from Fran{\c c}ois Chollet, yesterday}
\centering  \includegraphics[width = 0.8\textwidth]{figures/fortunatecollision}
\end{frame}
...
%      {\phantom{Program Induction and }\textcolor{black}{learning to synthesize}}\\
      {\phantom{Program Induction and }{\textcolor{gray}{synergy between DSL \& neural search}}}\\
    \end{tabular}
  \end{center}
\end{frame}
...
\begin{frame}{}
  \begin{center}
    \begin{tabular}{l}
      ...
      {\phantom{Program Induction and }\textcolor{gray}{learning a library}}\\
%      {\phantom{Program Induction and }\textcolor{gray}{learning to synthesize}}\\
      {\phantom{Program Induction and }{\textcolor{black}{synergy between library \& neural search}}}\\
    \end{tabular}
  \end{center}
\end{frame}
...
\begin{frame}{Lessons}
  ...
  Growing a library of abstractions interacts synergistically with learning how to use those abstractions

  \vspace{1cm}

  \pause

  Bayesian, symbolic learning algorithms mean you don't need massive data sets to learn libraries of abstractions

  \pause

  \vspace{1cm}

  Some abstractions can be bootstrapped without language---but surely natural language supervision would help...?
\end{frame}
...
\Wider[6em]{  \centering\begin{tabular}{ccc}
    ...
    \person{Cathy Wong}{collaborators/cw}\\\phantom{test}\\
